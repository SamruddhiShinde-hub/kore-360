...
const CARD_COLORS = [
  { text: 'var(--kore-purple)', border: 'rgba(159,61,151,0.35)' },
  { text: 'var(--kore-magenta)', border: 'rgba(183,30,96,0.35)' },
  { text: 'var(--kore-pink)', border: 'rgba(219,17,124,0.35)' },
  { text: 'var(--kore-orange)', border: 'rgba(240,81,35,0.35)' },
];

export default function Courses() {
  return (
    <section id="courses" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)', background: '#000000' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '92px 32px' }}>
        <div style={{ fontSize: '13px', letterSpacing: '0.16em', color: 'var(--kore-purple)', marginBottom: '16px' }}>02 — COURSES</div>
        ...
        <Reveal style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(290px,1fr))', gap: '20px' }}>
          {COURSES.map((c, i) => (
            <div key={i} className="card-hover" style={{ display: 'flex', flexDirection: 'column', background: '#000000', border: '1px solid rgba(255,255,255,0.09)', borderRadius: '14px', overflow: 'hidden' }}>
              <div style={{ aspectRatio: '16/9', overflow: 'hidden', borderBottom: '1px solid rgba(255,255,255,0.08)', background: '#111111' }}>
              ...
              <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                ...
                <p style={{ fontSize: '14.5px', lineHeight: 1.5, color: '#A0A0A0', margin: '0 0 22px', flex: 1 }}>{c.desc}</p>
