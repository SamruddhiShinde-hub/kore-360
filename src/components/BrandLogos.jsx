      ...
      <div className="brand-marquee" style={{ marginTop: '40px' }}>
        <div className="brand-marquee-track">
          {[...BRANDS, ...BRANDS].map((b, i) => (
            <div key={i} className="brand-tile" style={{ width: '230px', height: '128px', borderRadius: '12px', background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 'none', padding: '6px' }}>
              <img src={b.logo} alt={b.name} loading="lazy" decoding="async" width="218" height="116" style={{ maxWidth: '100%', maxHeight: '100%', width: 'auto', height: 'auto', objectFit: 'contain', display: 'block' }} />
            </div>
          ))}
        </div>
      </div>
