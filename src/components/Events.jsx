...
export default function Events() {
  return (
    <section id="events" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)', background: '#000000' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '92px 32px' }}>
        <div className="grid-2col" style={{ display: 'grid', gridTemplateColumns: '1fr 0.9fr', gap: '56px', alignItems: 'center' }}>
          <Reveal>
            <div style={{ fontSize: '13px', letterSpacing: '0.16em', color: 'var(--kore-purple)', marginBottom: '16px' }}>04 — EVENTS</div>
            ...
            <p style={{ fontSize: '17px', lineHeight: 1.55, color: '#A0A0A0', maxWidth: '520px', margin: '0 0 28px' }}>Keynotes, panels, campus sessions and brand appearances on careers and the business of sport. Tell us the date — we'll handle the rest.</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '32px' }}>
              {EVENT_TYPES.map((e, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '15.5px', color: '#A0A0A0' }}>
                  <span style={{ width: '7px', height: '7px', borderRadius: '50%', background: 'var(--kore-purple)', flex: 'none' }} />
                  {e}
                </div>
              ))}
            </div>
